...
const BookingForm: React.FC = () => {
  ...
  const validate = (): FormErrors => {
    ...
    else if (!/^\d+$/.test(formData.phone)) newErrors.phone = 'Invalid phone number';
  ...
  return (
    <form className="w-full" onSubmit={handleSubmit}>
      ...
      <div className="w-full mb-4">
        <p className="font-[DM-Sans-medium] text-[16px] text-white text-[16px]">Full Name*</p>
        <input
          name="fullName"
          ...
          className={`w-full h-[50px] bg-[#12121B] font-[DM-Sans-light] text-[#FFFFFF] text-[16px] placeholder:text-gray-500 border rounded-[10px] px-[10px] mt-[10px] w-full h-[50px] bg-[#12121B] font-[DM-Sans-light] text-[#FFFFFF]  text-[16px] placeholder:text-gray-500 border rounded-[10px] px-[10px] mt-[10px] dark-input ${
            errors.fullName ? 'border-red-500' : 'border-[rgba(255,255,255,0.12)]'
          }`}
          type="text"
          placeholder="Name"
        />
      ...
      {/* Phone */}
      <div className="w-full mb-4">
        <p className="font-[DM-Sans-medium] text-[16px] text-white text-[16px]">Phone Number*</p>
        <input
          name="phone"
      ...
      {/* Email */}
      <div className="w-full mb-4">
        <p className="font-[DM-Sans-medium] text-[16px] text-white text-[16px]">Email Address*</p>
        <input
          name="email"
      ...
      {/* Company */}
      <div className="w-full mb-4">
        <p className="font-[DM-Sans-medium] text-[16px] text-white text-[16px]">Company Name*</p>
        <input
          name="company"
          value={formData.company}
          onChange={handleChange}
          className={`w-full h-[50px] bg-[#12121B] font-[DM-Sans-light] text-[#FFFFFF] text-[16px] placeholder:text-gray-500 border rounded-[10px] px-[10px] mt-[10px] dark-input ${
            errors.company ? 'border-red-500' : 'border-[rgba(255,255,255,0.12)]'
          }`}
          type="text"
